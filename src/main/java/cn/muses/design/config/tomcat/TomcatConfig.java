        ...
        if (executor instanceof ThreadPoolExecutor) {
            try {
                ...
                if (threadPoolExecutor.awaitTermination(WAIT_TIME, TimeUnit.MILLISECONDS)) {
                    logger.info("Tomcat thread pool: {} closed, spend time: {}ms", threadPoolExecutor.toString(),
                        System.currentTimeMillis() - startTime);
                } else {
                    logger.info("Tomcat thread pool: {} forceClosed, spend time: {}ms", threadPoolExecutor.toString(),
                        System.currentTimeMillis() - startTime);
                }
